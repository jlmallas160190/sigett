    ...
    public void renderedCronograma(Proyecto proyecto) {
        try {
            if (proyecto.getId() != null) {
                /*Si estado de proyecto es pertinente*/
                if (proyecto.getEstadoProyectoId().getCodigo().equalsIgnoreCase(EstadoProyectoEnum.PERTINENTE.getTipo())) {
                    renderedEditarDatosCronograma = true;
                    renderedNoEditarDatosCronograma = false;
                } else {
                    renderedNoEditarDatosCronograma = true;
                    renderedEditarDatosCronograma = false;
                }
            } else {
                renderedEditarDatosCronograma = false;
                renderedNoEditarDatosCronograma = true;
