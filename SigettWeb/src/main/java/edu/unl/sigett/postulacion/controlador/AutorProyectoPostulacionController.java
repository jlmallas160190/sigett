...
import edu.unl.sigett.postulacion.controlador.AdministrarExpedientes;
...
//            int tienePermiso = usuarioDao.tienePermiso(usuario, "eliminar_autor_proyecto");
//            if (tienePermiso == 1) {
...
//                                int tienePermiso1 = usuarioDao.tienePermiso(usuario, "crear_renuncia_autor");
//                                if (tienePermiso1 == 1) {
...
//            ResourceBundle bundle = facesContext.getApplication().getResourceBundle(facesContext, "msg");
//            if (proyecto.getEstadoProyectoId().getCodigo().equalsIgnoreCase(EstadoProyectoEnum.INICIO.getTipo())) {
//                int tienePermiso = usuarioDao.tienePermiso(usuario, "select_autor_proyecto");
//                if (tienePermiso == 1) {
...
//            }
    ...
    public void buscarAspirantes(String criterio, Usuario usuario, Proyecto proyecto) {
        ...
        try {
//            if (proyecto.getEstadoProyectoId().getCodigo().equalsIgnoreCase(EstadoProyectoEnum.INICIO.getTipo())) {
//                int tienePermiso = usuarioDao.tienePermiso(usuario, "buscar_aspirante");
//                if (tienePermiso == 1) {
...
//                }
    ...
    public void renderedEditar(Usuario usuario) {
        int tienePermiso = usuarioDao.tienePermiso(usuario, "editar_autor_proyecto");
        if (tienePermiso == 1) {
            renderedEditar = true;
...
//            }
    ...
    public void renderedCrear(Usuario usuario) {
        int tienePermiso = usuarioDao.tienePermiso(usuario, "crear_autor_proyecto");
        if (tienePermiso == 1) {
            renderedCrear = true;
        } else {
            renderedCrear = false;
