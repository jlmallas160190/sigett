 ...
 */
package com.jlmallas.seguridad.entity;
...
@NamedQueries({
    ...
    @NamedQuery(name = "UsuarioPermiso.findById", query = "SELECT u FROM UsuarioPermiso u WHERE u.id = :id")})
