...
public class LineaInvestigacionDocente implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LineaInvestigacionDocente)) {
            return false;
        }
        LineaInvestigacionDocente other = (LineaInvestigacionDocente) object;
    ...
    public String toString() {
        return "edu.unl.sigett.entity.LineaInvestigacionDocente[ id=" + id + " ]";
    }
